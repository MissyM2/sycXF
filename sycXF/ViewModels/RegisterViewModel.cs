...
namespace sycXF.ViewModels
{
    public class RegisterViewModel : BaseViewModel
    {
        ...
        private IDataRepository<UserInfoModel> _userDataRepository;
        private IUserPreferences _userPreferences;

        public RegisterViewModel(INavigationService navigationService,
            IDataRepository<UserInfoModel> userDataRepository,
        ...
        private async Task RegisterUser()
        {
            ...
            await _userDataRepository.SaveAsync(user);
