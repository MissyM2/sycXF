...
namespace sycXF.Services.Basket
{
    public class BasketMockService : IBasketService
    {
        ...
        private CustomerBasket MockCustomBasket = new CustomerBasket
        {
            ...
            Items = new List<BasketItem>
                {
                    new BasketItem { Id = "1", PictureUrl = "fake_product_01.png", ProductId = Common.Common.MockMyClosetItemId01, ProductName = ".NET Bot Blue Sweatshirt (M)", Quantity = 1, UnitPrice = 19.50M },
                    new BasketItem { Id = "2", PictureUrl = "fake_product_04.png", ProductId = Common.Common.MockMyClosetItemId04, ProductName = ".NET Black Cup", Quantity = 1, UnitPrice = 17.00M }
                }
        };
